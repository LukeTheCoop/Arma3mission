...
class openGame2 {
	...
	{
		idc = 6;
		text = "You are able to get multiple diffrent types of vehicles located at the diffrent vendors around the map. Car vendors can be found in Kavala... while the helicopter vendor can be found at Athira airport. To pull out a vehicle go to the vendor, scroll wheel 'Get vehicle' and select the vehicle you would like to spawn. Remember to clear the spawn points, or else the vehicle wont spawn!"; //--- ToDo: Localize;
		x = 0.314375 * safezoneW + safezoneX;
		y = 0.313 * safezoneH + safezoneY;
		w = 0.20625 * safezoneW;
		h = 0.352 * safezoneH;
	...
	{
		idc = 8;
		text = "Here you can see the kavala car vendor. He is able to spawn a variety of vehicles. I achieved this by using the CIV vehicle configs."; //--- ToDo: Localize;
		x = 0.530937 * safezoneW + safezoneX;
		y = 0.555 * safezoneH + safezoneY;
		w = 0.165 * safezoneW;
		h = 0.11 * safezoneH;
...
class openGame4 {
	...
	{
		idc = 6;
		text = "Have fun blowing up cars, heli's, killing ai, and finding easter eggs! Oh I forgot... there is this weird guy in sofia, I dont recommend you talk to him."; //--- ToDo: Localize;
		x = 0.314375 * safezoneW + safezoneX;
		y = 0.313 * safezoneH + safezoneY;
		w = 0.20625 * safezoneW;
		h = 0.352 * safezoneH;
